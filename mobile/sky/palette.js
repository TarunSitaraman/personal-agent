...
const KEYS = [
  { e: -40, top: [1, 2, 8], mid: [3, 5, 13], hor: [7, 11, 28], glow: [60, 100, 230, 0], warm: 0, stars: 1 },
  { e: -18, top: [1, 2, 8], mid: [3, 5, 13], hor: [7, 11, 28], glow: [60, 100, 230, 0], warm: 0, stars: 1 },
  { e: -12, top: [2, 3, 10], mid: [5, 10, 28], hor: [14, 31, 82], glow: [60, 100, 230, 0.35], warm: 0, stars: 0.7 },
  { e: -6, top: [3, 6, 21], mid: [10, 26, 68], hor: [29, 68, 184], glow: [90, 140, 255, 0.55], warm: 0, stars: 0.35 },
...
export function skyPalette(elevation, weather = 'clear') {
  ...
  return {
    ...
    cloud: rgb(treat(k.mid, { ...w, sat: w.sat * 0.6 }).map(v => v * 0.82)),
